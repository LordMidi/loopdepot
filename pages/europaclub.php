<div class="container mb-4">
  <div class="row mb-5">
    <div class="col-lg-12 text-center">
      <img class="img-fluid rounded" src="images/europaclub/cover.jpg" alt="Europaclub Patch Pack">
    </div>
  </div>  
  <div class="row">
    <div class="col-lg-12">
      ...
      <p>
        It's very easy to create <strong>hypnotic electronic vibes</strong> with just a little bit of automation.
        All of the patches support the <strong>modulation wheel feature</strong> to increase the intensity of the sound.
      ...
      <p class="mt-5">
        ...
        <a class="btn btn-warning" href="https://www.reasonstudios.com/shop/product/europa-club/" target="_blank">
          buy @ Reason Studios
        </a>
        <a class="btn btn-success" href="https://loopdepot.gumroad.com/l/europa-club" target="_blank">
          buy @ Gumroad
        </a>
      </p>
    </div>
